    ...
    <div className='modal modal-open'>
        <div className='modal-box w-full max-w-2xl sm:max-w-3xl bg-base-100 shadow-xl'>
            ...
            <div className='text-left space-y-2'>
                ...
                <p>
                    <span className='font-semibold'>Rating </span>{movie.vote_average || "N/A"}
                </p>
                <p>
                    <span className='font-semibold'>Genres:</span> {movie.genres ? movie.genres.map(g=> g.name).join(", ") : "N/A"}
                </p>
            </div>
